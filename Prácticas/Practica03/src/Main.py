...
Descripción:
    ...
    diferentes ejercicios de la Práctica 3. Cada ejercicio está implementado
    en un módulo separado:

        1. Ejercicio 1 (Transfomaciones)
        2. Ejercicio 2 (Filtros y detección de bordes)
...
def menu():
    ...
    """
    print("=" * 50)
    print("        PRÁCTICA 3 — MENÚ DE EJERCICIOS")
    print("=" * 50)
    print("1. Ejercicio 1 (Transformaciones)")
    print("2. Ejercicio 2 (Filtros y detección de bordes)")
    print("0. Salir")
    print("-" * 50)
...
def ejecutarOpcion(opcion):
    ...
    Acciones
    --------
    - "1": Llama a Ejercicio1.iniciaProblema()
    - "2": Llama a Ejercicio2.iniciaProblema()
    - "0": Finaliza el programa
    """
    if opcion == "1":
        Ejercicio1.inicia_Ejercicio1()
    elif opcion == "2":
        Ejercicio2.inicia_Ejercicio2()
    elif opcion == "0":
        print("\nSaliendo... ¡Gracias!")
        sys.exit(0)
    else:
